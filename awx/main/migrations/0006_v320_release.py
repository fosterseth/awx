...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='fact',
            name='facts',
            field=models.JSONField(default=dict, help_text='Arbitrary JSON structure of module facts captured at timestamp for a single host.'),
        ),
        migrations.AddField(
            model_name='host',
            name='ansible_facts',
            field=models.JSONField(default=dict, help_text='Arbitrary JSON structure of most recent ansible_facts, per-host.'),
        ),
        migrations.AddField(
            model_name='host',
